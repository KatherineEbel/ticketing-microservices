    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                ticket = ticket_1.Ticket.build({ title: title, price: price, userId: req.currentUser.id });
                return [4 /*yield*/, ticket.save()];
            case 1:
                _b.sent();
                return [4 /*yield*/, new ticket_created_publisher_1.TicketCreatedPublisher(nats_client_1.stan.client).publish({
                        id: ticket.id,
                        title: ticket.title,
                        price: ticket.price,
